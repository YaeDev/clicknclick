...
function responsive() {
    if (document.body.offsetWidth < 768) {
        ...
        if (document.getElementById("search")) {
            ...
            document.getElementById("search").innerHTML = "Pesquisar";
        }
...
function unstickify(something) {
    ...
    something.style.margin = "0px 50px";
...
function stickify(something) {
    ...
    something.style.position = "fixed";
    something.style.margin = "0";
    something.style.boxShadow = "0px 6px 13px -7px rgba(0,0,0,0.20)";
...
//0px 6px 13px -7px rgba(0,0,0,0.20)
